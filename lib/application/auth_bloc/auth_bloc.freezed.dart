...
class _$_AuthEventunauthenticated implements _AuthEventunauthenticated {
  ...
  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is _AuthEventunauthenticated);
  }
...
class _$AuthStateTearOff {
  ...
  _AuthState call({required UserModel model, required bool isLoading}) {
    return _AuthState(
      model: model,
      isLoading: isLoading,
    );
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  $Res call({UserModel model, bool isLoading});
...
class _$_AuthState extends _AuthState {
  const _$_AuthState({required this.model, required this.isLoading})
      : super._();
  ...
  @override
  String toString() {
    return 'AuthState(model: $model, isLoading: $isLoading)';
  }
...
abstract class _AuthState extends AuthState {
  const factory _AuthState(
      {required UserModel model, required bool isLoading}) = _$_AuthState;
